  ...
  <div class="py-6">
    ...
    <div class="w-full form-content relative">
      ...
      >
        <div class="h-full w-full flex flex-col justify-between">
          ...
          <div class="w-full mt-6 space-x-4 flex justify-end">
            ...
            <button class="btn btn-success" @click="emits('submissionSuccess')">
              Done
            </button>
          </div>
        </div>
      ...
      <Form
        ...
        :initialValues="props.isEditing ? props.selectedItem : initialData"
        ref="addItemForm"
        class="space-y-2"
      >
        <div>
        ...
        <div class="flex flex-col md:flex-row md:space-x-4 w-full">
          <div class="w-full md:w-4/12">
            ...
            >
              ...
              >
                {{ CounCur.currency_code }} - {{ CounCur.currency_name }}
              </option>
            </SelectInput>
          </div>
          <div class="w-full md:w-4/12">
